...
Kompaktüberblick zur Datenanalyse mit R tidyverse Paketen
====================================================
...
- Wie baue ich komplexe Workflows mit pipes? (`magrittr`)
...
## Frage: Was ist der Unterschied zwischen `read_csv()` und `read_csv2()`?
...
**Frage:** Wieviele Zeilen haben die jeweiligen Datensätze? Und wie erklärt sich der Unterschied?
